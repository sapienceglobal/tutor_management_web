            ...
            <div className="flex items-center gap-3 ml-auto">
                ...
                <div className="hidden md:flex items-center relative">
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-64 h-10 pl-4 pr-10 bg-white border border-[#E5E7EB] rounded-lg text-sm text-[#1F2937] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] focus:border-transparent transition-all"
                    />
                ...
                <div className="relative ml-2">
                    ...
                    {isProfileOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-slate-100 py-1 animate-in fade-in slide-in-from-top-2 z-50">
                            ...
                            <button className="w-full text-left px-4 py-2 text-sm text-slate-600 hover:bg-[var(--primary-color)]/10 hover:text-[var(--primary-color)] flex items-center gap-2">
