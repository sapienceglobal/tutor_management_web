        ...
        <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-sm border-b border-slate-200/70 shadow-[0_1px_3px_0_rgba(0,0,0,0.04)]">
            <div className="h-[60px] flex items-center justify-between px-4 lg:px-5 gap-3">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <h1 className="text-[15px] font-bold text-slate-800 hidden sm:block tracking-tight">
                        Student Panel
                    </h1>
                </div>
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full h-9 pl-9 pr-4 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 placeholder-slate-400
                                focus:outline-none focus:bg-white focus:border-indigo-300 focus:ring-2 focus:ring-indigo-500/10 transition-all"
                        />
                    </div>
                </form>
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            ...
                            >
                                <div className="w-8 h-8 rounded-full overflow-hidden ring-2 ring-indigo-200/80 flex-shrink-0">
                                    <img
                        ...
                        <DropdownMenuContent align="end" className="w-56 bg-white shadow-xl border border-slate-200 rounded-2xl py-1.5 mt-1">
                            <DropdownMenuLabel className="px-3 py-2">
                                <div className="flex items-center gap-2.5">
                                    <div className="w-9 h-9 rounded-full overflow-hidden ring-2 ring-indigo-100 flex-shrink-0">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        {institute && (
                                            <div className="flex items-center gap-1 mt-0.5">
                                                ...
                                                <p className="text-[10px] text-indigo-600 font-semibold truncate">{institute.name}</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
