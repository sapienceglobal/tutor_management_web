...
export const C = {
  ...
  // ✅ PASS / SUCCESS (Emerald)
  success: "#10B981",
  successBg: "rgba(16, 185, 129, 0.12)", // 12% opacity (Crisp look)
  successBorder: "rgba(16, 185, 129, 0.30)", // 30% opacity (Sharp border)
  // ⚠️ WARNING / PENDING (Amber)
  warning: "#F59E0B",
