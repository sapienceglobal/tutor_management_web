...
const LoginPageClient = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const themeRole =
                ...
                'admin'; // admin/superadmin → no role-specific theme needed
    ...
    const handleGoogleLogin = () => { window.location.href = `${BACKEND_URL}/auth/google`; };
    const handleGitHubLogin = () => { window.location.href = `${BACKEND_URL}/auth/github`; };
            ...
            <div className="relative z-10 w-full max-w-5xl p-4 lg:p-8">
                <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden grid lg:grid-cols-2 min-h-[600px]">
                    ...
                    <div className="relative hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-indigo-600/90 to-purple-700/90 text-white">
                        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497633762265-9d179a990aa6?q=80&w=2073&auto=format&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-20" />
                        <div className="relative z-10">
                            ...
                            <h2 className="text-4xl font-bold leading-tight mb-6">Unlock your potential with expert guidance.</h2>
                            <p className="text-indigo-100 text-lg leading-relaxed max-w-sm">Join our community of learners and educators to achieve your academic goals.</p>
                        </div>
                        <div className="relative z-10">
                            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                                ...
                                <div className="mt-3 flex items-center gap-3">
                                    ...
                                    <div className="text-xs"><div className="font-bold">Sarah Jenkins</div><div className="opacity-70">Student, Harvard</div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-md mx-auto w-full">
                            ...
                            {error && (
                                <div className="mb-6 space-y-3">
                                    ...
                                    {oauthResetEmail && (
                                        <a href={`/forgot-password?email=${encodeURIComponent(oauthResetEmail)}`}
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <Input id="email" name="email" type="email" required placeholder="name@example.com"
                                            className={cn("pl-12 h-12 bg-white/50 border-slate-200 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all rounded-xl shadow-sm",
                                                isClient && sessionStorage.getItem('inviteEmail') ? "bg-gray-100 cursor-not-allowed" : "")}
                                ...
                                <Button type="submit" disabled={isLoading}
                                    className="w-full h-12 text-base font-bold bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl transition-all hover:scale-[1.02] active:scale-[0.98] mt-2"
                                    style={{ boxShadow: "0 10px 30px -10px rgba(79,70,229,0.4)" }}>
                                    {isLoading
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Button variant="outline" type="button" onClick={handleGoogleLogin}
                                    className="h-12 border-slate-200 hover:bg-white/60 rounded-xl bg-white/40 transition-all hover:scale-[1.02]">
                            ...
                            <p className="text-center text-sm text-slate-600 mt-8">
                                ...
                                <a href="/register" className="font-bold text-indigo-600 hover:underline">Create free account</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div className="absolute bottom-4 text-slate-400 text-xs text-center w-full z-10">
                    &copy; 2026 Sapience LMS. All rights reserved.
                </div>
            </div>
        </div>
    );
