...
import { 
    MdHourglassEmpty, MdActivity, MdDns, MdWarning, MdStorage, 
    MdMemory, MdAccessTime, MdErrorOutline, MdAutoAwesome, MdGppMaybe, MdArticle,
    MdSettings, MdRefresh
} from 'react-icons/md';
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center shrink-0" 
                        ...
                        <MdSettings style={{ width: 24, height: 24, color: C.danger }} />
                    </div>
                    <div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <MdRefresh style={{ width: 18, height: 18, color: C.btnPrimary }}/> Refresh Pulse
                    </button>
                </div>
            </div>
