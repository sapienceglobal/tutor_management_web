    ...
    return (
        <div className="text-sm prose prose-sm max-w-none text-slate-700 leading-relaxed font-sans">
            <ReactMarkdown
                ...
                components={{
                    h1: ({ node, ...props }) => <h1 className="text-base font-extrabold text-[#1E1B4B] mt-3 mb-1" {...props} />,
                    h2: ({ node, ...props }) => <h2 className="text-sm font-bold text-[#1E1B4B] mt-3 mb-1" {...props} />,
                    h3: ({ node, ...props }) => <h3 className="text-xs font-semibold text-[#1E1B4B] mt-2 mb-0.5" {...props} />,
                    p: ({ node, ...props }) => <p className="mb-2 last:mb-0 text-[#374151] leading-relaxed" {...props} />,
                    ul: ({ node, ...props }) => <ul className="list-disc pl-4 mb-2 space-y-1 text-[#374151]" {...props} />,
                    ol: ({ node, ...props }) => <ol className="list-decimal pl-4 mb-2 space-y-1 text-[#374151]" {...props} />,
                    li: ({ node, ...props }) => <li className="text-[#374151] text-sm leading-relaxed" {...props} />,
