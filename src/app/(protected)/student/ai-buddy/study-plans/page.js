    ...
    const init = async () => {
      ...
      try {
        ...
        if (coursesRes.data?.success) {
          setCourses(
            (coursesRes.data.enrollments || []).map((e) => e.courseId),
          );
        }
      } catch (err) {
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            {!aiPlan ? (
              ...
              <div
                className="rounded-[32px] overflow-hidden relative shadow-md border"
                style={{
              ...
              >
                ...
                <div className="relative text-center py-16 px-6 flex flex-col items-center">
                  <div
                    className="w-16 h-16 rounded-[1.5rem] flex items-center justify-center mb-6 shadow-2xl"
                    style={{
                  ...
                  >
                    Our AI analyzes your test history and weak areas to create a
                    high-impact daily study path.
                  </p>
                  <button
              ...
              <div className="space-y-6">
                  ...
                  <div className="relative p-6 md:p-8">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        >
                          Optimized for your current performance trend:{" "}
                          <span className="text-amber-300">
                            {aiPlan.performanceAnalysis?.trends}
                          </span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        {
                          label: "Duration",
                          value: aiPlan.duration,
                          icon: Clock,
                        },
                        {
                          label: "Daily Goal",
                          value: aiPlan.dailyGoal,
                          icon: Target,
                        },
                        {
                          label: "Focus Areas",
                          value: `${aiPlan.focusAreas?.length || 0} Topics`,
                          icon: BookOpen,
                        },
                        {
                          label: "Expected",
                          value: aiPlan.expectedImprovement,
                          icon: TrendingUp,
                        },
                      ].map((s, i) => (
                        <div
                          key={i}
                          className="rounded-2xl p-4 text-center border border-white/5 bg-white/5 backdrop-blur-sm"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div
                    className="rounded-3xl p-6 shadow-sm border bg-white"
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {aiPlan.focusAreas?.map((focus, i) => (
                        <div
                          key={i}
                          className="rounded-2xl p-4 border bg-gray-50 transition-transform hover:-translate-y-0.5"
                          style={{ borderColor: P.border }}
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span
                              className={`px-2.5 py-1 rounded-md shrink-0 text-[9px] font-black uppercase tracking-wider ${focus.priority === "High" ? "bg-red-100 text-red-700 border border-red-200" : "bg-orange-100 text-orange-700 border border-orange-200"}`}
                            >
                              {focus.priority}
                            </span>
                          </div>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        {aiPlan.recommendations
                          ...
                          .map((action, i) => (
                            <div
                              key={i}
                              className="flex items-start gap-3 p-3 rounded-xl border bg-gray-50"
                              style={{ borderColor: P.border }}
                            >
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {Object.entries(aiPlan.weeklySchedule || {}).map(
                          ([day, task], i) => (
          ...
          <section>
            ...
            {tutorPlans.length === 0 ? (
              <div
                className="text-center py-12 rounded-2xl bg-white border"
                style={{ borderColor: P.border }}
              >
                <CalendarCheck
                  className="w-10 h-10 mx-auto mb-3"
                  style={{ color: `${P.primary}35` }}
                />
                <p
                  style={{
                    fontSize: T.size.sm,
                ...
                <p style={{ fontSize: T.size.xs, color: P.textMuted }}>
                  Plans directly assigned by your tutors will appear here.
                </p>
              </div>
            ) : (
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 flex-wrap">
                            ...
                            <span
                              className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${plan.status === "active" ? "bg-green-50 text-green-600" : plan.status === "completed" ? "bg-blue-50 text-blue-600" : "bg-orange-50 text-orange-600"}`}
                            >
                              {plan.status || "active"}
                            </span>
                            <span
                        ...
                        <div className="flex items-center gap-4 flex-shrink-0">
                          {plan.durationWeeks && (
                            <div className="text-center hidden sm:block">
                              ...
                              <p
                                style={{ fontSize: "9px", color: P.textMuted }}
                              >
                                weeks
                              </p>
                            </div>
                          ...
                          <ChevronDown
                            className={`w-5 h-5 transition-transform duration-200 ${expandedPlan === plan._id ? "rotate-180" : ""}`}
                            style={{ color: P.textMuted }}
                          />
                        </div>
                      </div>
                          ...
                          <div className="mt-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {plan.weeklyPlan.map((week, wi) => (
                                <div
                                  key={wi}
                                  className="rounded-xl p-4 bg-gray-50 border"
                                  style={{ borderColor: P.border }}
                                >
                                  <div className="flex items-center gap-2 mb-2">
                                    <div
