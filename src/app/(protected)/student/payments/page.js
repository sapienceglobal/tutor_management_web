...
export default function PaymentsPage() {
    ...
    return (
        <div className="min-h-screen space-y-6" style={{ backgroundColor: C.pageBg, fontFamily: T.fontFamily, color: C.text }}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5" style={{ backgroundColor: C.cardBg, borderRadius: R['2xl'], border: `1px solid ${C.cardBorder}`, boxShadow: S.card }}>
                <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center shrink-0" style={{ width: 48, height: 48, backgroundColor: C.iconBg, borderRadius: '10px' }}>
                        <MdArticle style={{ width: 24, height: 24, color: C.iconColor }} />
                    </div>
                    <div>
                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="px-6 py-4 flex items-center justify-between" style={{ borderBottom: `1px solid ${C.cardBorder}`, backgroundColor: C.innerBg }}>
                            <div className="flex items-center gap-2.5">
                                <div className="flex items-center justify-center rounded-lg shrink-0"
                                    ...
                                    <MdAccountBalanceWallet style={{ width: 16, height: 16, color: C.iconColor }} />
                                </div>
                            ...
                            <button
                                ...
                                style={{ ...cx.btnSecondary(), borderRadius: '10px', fontSize: T.size.base }}
                            >
                    ...
                    <div className="overflow-hidden" style={{ backgroundColor: C.cardBg, borderRadius: R['2xl'], border: `1px solid ${C.cardBorder}`, boxShadow: S.card }}>
                                ...
                                <thead>
                                    <tr style={{ borderBottom: `1px solid ${C.cardBorder}`, backgroundColor: C.innerBg }}>
                                        {['ID', 'Description', 'Amount', 'Status', 'Date', 'Invoice'].map(h => (
                                            <th key={h} className="py-3 px-4" style={{ fontSize: T.size.xs, fontWeight: T.weight.bold, color: C.textMuted, textTransform: 'uppercase', letterSpacing: T.tracking.wider }}>{h}</th>
                                        ))}
                                    </tr>
                                </thead>
                                <tbody>
                                    {pagePayments.length === 0 ? (
                                        ...
                                        pagePayments.map((payment) => (
                                            <tr key={payment._id} className="transition-colors hover:bg-black/5" style={{ borderBottom: `1px solid ${C.cardBorder}` }}>
                                                <td className="py-3 px-4" style={{ fontSize: T.size.base, fontWeight: T.weight.bold, color: C.heading }}>{formatPaymentId(payment)}</td>
                                                <td className="py-3 px-4" style={{ fontSize: T.size.base, fontWeight: T.weight.semibold, color: C.text }}>{getDescription(payment)}</td>
                                                <td className="py-3 px-4" style={{ fontSize: T.size.base, fontWeight: T.weight.bold, color: C.heading }}>₹{Number(payment.amount).toLocaleString('en-IN')}</td>
                                                ...
                                                <td className="py-3 px-4" style={{ fontSize: T.size.base, fontWeight: T.weight.semibold, color: C.text }}>
                                                ...
                                                <td className="py-3 px-4">
                                                    {payment.status === 'paid' && payment.invoiceNumber ? (
                                                        ...
                                                        <button
                                                            ...
                                                            style={{ background: C.gradientBtn, color: '#ffffff', borderRadius: '10px', fontSize: T.size.xs, fontWeight: T.weight.bold, fontFamily: T.fontFamily }}
                                                        ...
                                                        <span style={{ color: C.textMuted, fontWeight: T.weight.semibold }}>—</span>
                                                    )}
                                                </td>
                                            </tr>
                                        ))
                        ...
                        {filteredPayments.length > 0 && (
                            <div className="px-6 py-4 flex items-center justify-between" style={{ borderTop: `1px solid ${C.cardBorder}`, backgroundColor: C.innerBg }}>
                                <p style={{ fontSize: T.size.xs, color: C.textMuted, fontWeight: T.weight.semibold, margin: 0, letterSpacing: T.tracking.wider, textTransform: 'uppercase' }}>
                                    ...
                                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                style={currentPage === p
                                                    ? { backgroundColor: C.btnPrimary, color: '#fff', fontSize: T.size.sm, fontWeight: T.weight.bold, borderRadius: '10px', boxShadow: S.card }
                                                    : { backgroundColor: 'transparent', color: C.textMuted, fontSize: T.size.sm, fontWeight: T.weight.bold, borderRadius: '10px' }}
                                            >
                                                {p}
                                            </button>
                                        );
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-6 p-5" style={{ backgroundColor: C.cardBg, borderRadius: R['2xl'], border: `1px solid ${C.cardBorder}`, boxShadow: S.card }}>
                        <div className="flex items-center justify-between mb-5">
                            <h3 style={{ fontSize: T.size.lg, fontWeight: T.weight.bold, color: C.heading, margin: 0 }}>Filter Payments</h3>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="relative">
                                        <span style={{ fontSize: T.size.xs, fontWeight: T.weight.bold, color: C.textMuted, display: 'block', marginBottom: '2px' }}>From</span>
                                        <input
                                            type="date"
                                            value={dateFrom}
                                    ...
                                    <div className="relative">
                                        <span style={{ fontSize: T.size.xs, fontWeight: T.weight.bold, color: C.textMuted, display: 'block', marginBottom: '2px' }}>To</span>
                                        <input
                                            type="date"
                                            value={dateTo}
