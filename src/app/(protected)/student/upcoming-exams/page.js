...
export default function UpcomingExamsPage() {
    ...
    const getUrgencyBadge = (date) => {
        ...
        if (days <= 3)  return { bg: 'rgba(239,68,68,0.1)',    color: '#ef4444', label: `${days}d` };
        return {
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    />
                    <p className="text-sm font-medium" style={{ color: 'var(--theme-foreground)', opacity: 0.45 }}>
                        Loading your exams…
                    </p>
                </div>
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
                ...
                <Link
                    ...
                    onMouseEnter={e => {
                        ...
                        e.currentTarget.style.backgroundColor = 'color-mix(in srgb, var(--theme-primary) 5%, var(--theme-background))';
                    }}
                    onMouseLeave={e => {
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {[
                    ...
                    >
                        ...
                        <div>
                            <p className="text-xs font-semibold" style={{ color: 'var(--theme-foreground)', opacity: 0.45 }}>
                                {stat.label}
                            </p>
                            <p className="text-2xl font-black leading-none mt-0.5" style={{ color: 'var(--theme-primary)' }}>
                                {stat.value}
                            </p>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 space-y-3">
                    <div className="flex items-center gap-2">
                        <h2 className="text-base font-black" style={{ color: 'var(--theme-foreground)' }}>
                            All Upcoming Exams
                        </h2>
                        {exams.length > 0 && (
                            <span
                    ...
                    {exams.length === 0 ? (
                        <div
                            className="rounded-2xl p-14 text-center border"
                        ...
                        >
                            ...
                            <h3 className="font-black text-base" style={{ color: 'var(--theme-foreground)' }}>
                                No Upcoming Exams
                            </h3>
                            <p className="text-sm mt-1" style={{ color: 'var(--theme-foreground)', opacity: 0.4 }}>
                            ...
                            {exams.map((exam) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onMouseEnter={e => {
                                            e.currentTarget.style.borderColor = 'color-mix(in srgb, var(--theme-primary) 35%, transparent)';
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-bold text-sm truncate" style={{ color: 'var(--theme-foreground)' }}>
                                                {exam.title}
                                            </h3>
                                            <div className="flex items-center flex-wrap gap-x-3 gap-y-0.5 mt-1">
                                                <span className="text-xs flex items-center gap-1" style={{ color: 'var(--theme-foreground)', opacity: 0.4 }}>
                                        ...
                                        <Link href={`/student/exams/${exam._id}`}>
                                            <button
                                                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold text-white shrink-0 transition-all"
                ...
                <div className="space-y-4">
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-sm font-black" style={{ color: 'var(--theme-foreground)' }}>
                                {monthName}
                            </h3>
                        ...
                        <div className="grid grid-cols-7 text-center mb-1">
                            {['Su','Mo','Tu','We','Th','Fr','Sa'].map(d => (
                                <div key={d} className="py-0.5 text-[10px] font-black uppercase tracking-wider"
                                    style={{ color: 'var(--theme-foreground)', opacity: 0.3 }}>
                                    {d}
                                </div>
                            ))}
                        </div>
                            ...
                            {Array.from({ length: daysInMonth }, (_, i) => {
                                ...
                                return (
                                    <div key={day} className="flex flex-col items-center py-1">
                                        <div
                                            className="w-7 h-7 rounded-lg flex items-center justify-center text-[12px] font-semibold transition-all"
                                            style={
                                                isToday
                                                    ? { backgroundColor: 'var(--theme-primary)', color: 'white', fontWeight: 800 }
                                                    : hasExam
                                                        ? { backgroundColor: 'color-mix(in srgb, var(--theme-primary) 14%, transparent)', color: 'var(--theme-primary)', fontWeight: 700 }
                                                        : { color: 'var(--theme-foreground)', opacity: 0.55 }
                                            }
                                        >
                                            {day}
                                        </div>
                        ...
                        <div className="flex items-center gap-4 mt-3 pt-3 border-t" style={{ borderColor: 'var(--theme-border)' }}>
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-[11px] font-medium" style={{ color: 'var(--theme-foreground)', opacity: 0.45 }}>Today</span>
                            </div>
                            <div className="flex items-center gap-1.5">
                                <div className="w-3 h-3 rounded" style={{ backgroundColor: 'color-mix(in srgb, var(--theme-primary) 18%, transparent)', outline: '1.5px solid var(--theme-primary)', outlineOffset: '0px' }} />
                                <span className="text-[11px] font-medium" style={{ color: 'var(--theme-foreground)', opacity: 0.45 }}>Has Exam</span>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <h3 className="text-sm font-black mb-4" style={{ color: 'var(--theme-foreground)' }}>
                            Exam Timeline
                        </h3>

                        {timeline.length === 0 ? (
                            <p className="text-xs text-center py-6" style={{ color: 'var(--theme-foreground)', opacity: 0.3 }}>
                                    ...
                                    <div key={gi}>
                                        <div className="flex items-center gap-2 mb-2.5">
                                            ...
                                            <span
                                                ...
                                                style={{ color: 'var(--theme-foreground)', opacity: 0.4 }}
                                            >
                                                {group.label}
                                            </span>
                                        </div>
                                        <div className="ml-3.5 pl-4 space-y-3" style={{ borderLeft: `2px solid ${group.color}28` }}>
                                            {group.exams.slice(0, 3).map((exam, ei) => (
                                                <div key={ei}>
                                                    ...
                                                    <p className="text-[11px] flex items-center gap-1 mt-0.5" style={{ color: 'var(--theme-foreground)', opacity: 0.38 }}>
                                                        <Clock className="w-3 h-3" />
                                                        {new Date(exam.startDate || exam.createdAt).toLocaleDateString('en-US', {
                                                            month: 'short', day: 'numeric', year: 'numeric',
                                                        })}
                                            ...
                                            {group.exams.length > 3 && (
                                                <p className="text-[11px] font-semibold" style={{ color: 'var(--theme-primary)', opacity: 0.65 }}>
