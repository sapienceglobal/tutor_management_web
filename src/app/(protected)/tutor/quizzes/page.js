            ...
            {loading ? (
                ...
                <div className="space-y-4">
                    ...
                    {filteredExams.length === 0 ? (
                        <div
                            className="p-12 text-center border border-dashed"
                            style={{
                                backgroundColor: C.cardBg,
                                borderColor: C.cardBorder,
                                borderRadius: R['2xl'],
                                    ...
                                    <div className="flex items-start gap-3 flex-1 min-w-0">
                                        ...
                                        <div className="min-w-0 flex flex-col gap-1.5">
                                            <div className="flex items-center gap-2.5 flex-wrap">
                                                ...
                                                <span className={`inline-flex items-center rounded-md px-2 py-0.5 text-[9px] uppercase tracking-wider font-extrabold ${getAudienceDisplay(exam).badgeClass}`}>
                                                    {getAudienceDisplay(exam).label}
                                                </span>

                                                {/* Status Badge */}
                                                <span
                                                    className="inline-flex items-center px-2.5 py-0.5 uppercase animate-none"
                                                    style={{
                                                        fontFamily: T.fontFamily,
                                                        fontSize: T.size.xs,
                                                        fontWeight: T.weight.bold,
