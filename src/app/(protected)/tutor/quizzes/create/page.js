        ...
        return (
          <div key={step.id} className="flex items-center">
            ...
            >
              ...
              >
                {isCompleted ? (
                  <MdCheck style={{ width: 14, height: 14 }} />
                ) : (
                  idx + 1
                )}
              </div>
            ...
            {idx < steps.length - 1 && (
              <div
                ...
                style={{
                  width: 24,
                  height: 2,
                  backgroundColor: isCompleted ? C.btnPrimary : C.innerBg,
                }}
              />
            )}
          </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="mx-2"
          style={{ width: 1, height: 16, backgroundColor: C.cardBorder }}
        />
        <button
        ...
        >
          <MdFormatListBulleted
            style={{ width: 16, height: 16, color: C.heading }}
          />
        </button>
        <button
...
const ToggleRow = ({
  ...
  >
    ...
    <CustomSwitch
      checked={examData[keyName]}
      onChange={(val) => setExamData({ ...examData, [keyName]: val })}
    />
  </div>
);
...
function CreateExamPageClient() {
  ...
  const totalQuestionMarks = (examData?.questions || []).reduce(
    (sum, q) => sum + (q?.points || 1),
    0,
  );
  const derivedPassingMarks =
    totalQuestionMarks > 0
      ? Number(
          (
            ((Number(examData?.passingPercentage) || 0) / 100) *
            totalQuestionMarks
          ).toFixed(2),
        )
      : 0;
  ...
  const handleCorrectSelect = (idx) => {
    setCurrentQuestion({
      ...currentQuestion,
      options: currentQuestion.options.map((op, i) => ({
        ...op,
        isCorrect: i === idx,
      })),
    });
  ...
  useEffect(() => {
    const fetchAudienceTargets = async () => {
      ...
      try {
        ...
        const batchList = (batchesRes?.data?.batches || []).filter(
          (b) => (b.courseId?._id || b.courseId) === examData.courseId,
        );
  ...
  const fetchBankQuestions = async () => {
    ...
    try {
      ...
      if (bankFilters?.difficulty !== "all")
        params.append("difficulty", bankFilters.difficulty);
      if (bankFilters?.topicId !== "all")
        params.append("topicId", bankFilters.topicId);
  ...
  useEffect(() => {
    if (isBankOpen) fetchBankQuestions();
  ...
  const handleImportFromBank = () => {
    ...
    const questionsToImport = bankQuestions.filter((q) =>
  ...
  const handleSaveAndProceed = async (options = {}) => {
    const { status = "draft", shouldRedirect = false } =
      options && options.preventDefault ? {} : options;
    ...
    try {
      ...
      const payload = {
        ...
        batchId:
          safeAudience.scope === "batch"
            ? safeAudience.batchIds?.[0] || null
            : null,
      };
      let response;
      ...
      >
        ...
        <div className="flex gap-3">
          <button
            ...
            onClick={() =>
              handleSaveAndProceed({ status: "draft", shouldRedirect: true })
            }
            style={{
        ...
        <AnimatePresence mode="wait">
              ...
              <StepCard>
                <div className="space-y-8">
                  <div className="text-center mb-8">
                    ...
                    >
                      Start by providing the fundamental details of your
                      assessment.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        style={{
                          ...baseInputStyle,
                          borderColor: errors.title ? C.danger : C.cardBorder,
                        }}
                  ...
                  <div className="space-y-2">
                    ...
                    <RichTextEditor
                      ...
                      onChange={(html) =>
                        setExamData({ ...examData, description: html })
                      }
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <span style={{ fontWeight: T.weight.bold }}>
                          {derivedPassingMarks}
                        </span>
                        <span
                          style={{
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          >
                            Allow any student to access without prior enrollment
                          </p>
                        </div>
                      </div>
                      <CustomSwitch
                        ...
                        onChange={(val) =>
                          setExamData({ ...examData, isFree: val })
                        }
                      />
                    </div>
                    <div
              ...
              <StepCard>
                <div className="space-y-10">
                  <div className="text-center mb-10">
                    ...
                    >
                      Setup rules, scoring, and high-level security for this
                      assessment.
                    </p>
                  </div>
          ...
          {activeTab === "questions" && (
            ...
            >
              <StepCard>
                <div
                  className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 pb-6"
                  style={{ borderBottom: `1px solid ${C.cardBorder}` }}
                >
                  <div>
                    <h2
                    ...
                    >
                      Manually author questions or use AI to generate them
                      instantly.
                    </p>
                  </div>
                  <div className="flex gap-3 w-full md:w-auto flex-wrap">
                    <FeatureGate featureName="aiAssessment" mode="lock">
                      ...
                      >
                        <MdAutoAwesome style={{ width: 16, height: 16 }} /> AI
                        Generate
                      </button>
                    </FeatureGate>
                    <button
                    ...
                    >
                      <MdLibraryBooks style={{ width: 16, height: 16 }} />{" "}
                      Import
                    </button>
                    <button
                      onClick={() => {
                ...
                {examData.questions.length === 0 ? (
                  <div
                    className="text-center flex flex-col items-center border-2 border-dashed"
                    style={{
                      backgroundColor: C.innerBg,
                  ...
                  >
                    ...
                    <FeatureGate featureName="aiAssessment" mode="lock">
                      ...
                      >
                        <MdAutoAwesome style={{ width: 16, height: 16 }} />{" "}
                      ...
                      >
                        ...
                        >
                          <button
                            ...
                            className="flex items-center justify-center cursor-pointer transition-all hover:opacity-70"
                            style={{
                              width: 32,
                              height: 32,
                              borderRadius: "10px",
                                  ...
                                  <span
                                    ...
                                    style={{
                                      ...
                                      backgroundColor: opt.isCorrect
                                        ? C.success
                                        : C.innerBg,
                                      color: opt.isCorrect ? "#fff" : C.text,
                                    }}
                                  >
                ...
                <div
                  className="flex justify-between pt-8 mt-10"
                  style={{ borderTop: `1px solid ${C.cardBorder}` }}
                >
                  <button
            ...
            >
              <StepCard>
                <div className="space-y-10">
                  ...
                  >
                    <div
                      className="flex items-start justify-between pb-6 mb-8"
                      style={{ borderBottom: `1px solid ${C.cardBorder}` }}
                    >
                      <div className="flex gap-4">
                        <div
                        ...
                        <div>
                          ...
                          >
                            Enable this to lock the exam outside of the
                      ...
                      <CustomSwitch
                        ...
                        onChange={(val) =>
                          setExamData({ ...examData, isScheduled: val })
                        }
                      />
                    </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <div>
                              ...
                              >
                                Once published, students can access this quiz
                                immediately and anytime.
                              </p>
                            </div>
                          </div>
                        </motion.div>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: T.weight.bold,
                        border: "none",
                        boxShadow: `0 4px 14px ${C.success}30`,
                        height: 48,
                        padding: "0 40px",
                      }}
                    >
