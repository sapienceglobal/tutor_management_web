                ...
                <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-100">
                    ...
                    <div className="relative">
                        ...
                        <input placeholder="Search skills..."
                            ...
                            className="pl-8 pr-3 h-8 text-sm border border-slate-200 rounded-xl focus:outline-none focus:border-[var(--theme-primary)] focus:ring-2 focus:ring-[var(--theme-primary)]/10 w-52 transition-colors" />
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-14">
                        <div className="mx-auto w-12 h-12 rounded-2xl flex items-center justify-center mb-3"
                            ...
                            <BrainCircuit className="w-6 h-6" style={{ color: 'var(--theme-primary)' }} />
                        </div>
